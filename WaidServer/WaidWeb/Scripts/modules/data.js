...
*/
(function(m) {
    var l = m.each, n = function(a) { this.init(a); };
    m.extend(n.prototype, {
        ...
        parseTable: function() {
            ...
            b && (typeof b === "string" && (b = document.getElementById(b)), l(b.getElementsByTagName("tr"), function(a, b) {
                g = 0;
                b >= c && b <= f && l(a.childNodes, function(a) { if ((a.tagName === "TD" || a.tagName === "TH") && g >= e && g <= j) d[g] || (d[g] = []), d[g][b - c] = a.innerHTML, g += 1; });
            }));
        },
        ...
        parseTypes: function() { for (var a = this.columns, b = a.length, d, c, f, e; b--;) for (d = a[b].length; d--;) c = a[b][d], f = parseFloat(c), e = this.trim(c), e == f ? (a[b][d] = f, f > 31536E6 ? a[b].isDatetime = !0 : a[b].isNumeric = !0) : (c = Date.parse(c), b === 0 && typeof c === "number" && !isNaN(c) ? (a[b][d] = c, a[b].isDatetime = !0) : a[b][d] = e); },
    ...
    m.Data = n;
    m.data = function(a) { return new n(a); };
})(Highcharts);