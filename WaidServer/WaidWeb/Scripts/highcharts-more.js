...
(function(h, t) {
    ...
    function z(a, b, c) { this.init.call(this, a, b, c); }
    ...
    var x = q.prototype, q = F.prototype, G = { getOffset: s, redraw: function() { this.isDirty = !1; }, render: function() { this.isDirty = !1; }, setScale: s, setCategories: s, setTitle: s }, E = {
        ...
        setOptions: function(a) { this.options = o(this.defaultOptions, this.defaultRadialOptions, a); },
        getOffset: function() {
        ...
        beforeSetTickPositions: function() { this.autoConnect && (this.max += this.categories && 1 || this.pointRange || this.closestPointRange); },
    ...
    l(x, "init", function(a,
        ...
        if (f) {
            if (u(this, i ? G : E), m = !g) this.defaultRadialOptions = this.defaultRadialGaugeOptions;
        } else if (e) u(this, E), this.defaultRadialOptions = (m = g) ? this.defaultRadialXOptions : o(this.defaultYAxisOptions, this.defaultRadialYOptions);
        a.call(this, b, c);
        if (!i && (f || e)) {
            a = this.options;
            if (!b.panes) b.panes = D(h.splat(b.options.pane), function(a) { return new z(a, b, d); });
            ...
            if ((this.isCircular = m) && c.max === t && e - f === 2 * Math.PI) this.autoConnect = !0;
        }
    });
    ...
    k.arearange = h.extendClass(k.area, {
        ...
        translate: function() {
            ...
            p(this.points, function(b) { if (b.y !== null) b.plotLow = b.plotY, b.plotHigh = a.translate(b.high, 0, 1, 0, 1); });
        },
        getSegmentPath: function(a) {
            for (var b =
                [], c = a.length, d = y.prototype.getSegmentPath, f; c--;) f = a[c], b.push({ plotX: f.plotX, plotY: f.plotHigh });
            a = d.call(this, a);
            d = d.call(this, b);
            b = [].concat(a, d);
            d[0] = "L";
        ...
        drawDataLabels: function() {
            ...
            if (e.enabled || this._hasPointLabels) {
                ...
                for (c = b; c--;) g = a[c], g.dataLabelUpper = g.dataLabel, g.dataLabel = d[c], g.y = g.low, g.plotY = g.plotLow, i ? (e.align = "right", e.x = e.xLow) : e.y = e.yLow;
                f.drawDataLabels.apply(this, arguments);
            }
        },
        getSymbol: k.column.prototype.getSymbol,
        drawPoints: s
    });
    ...
    j.gauge = o(j.line, {
        dataLabels: { enabled: !0, y: 30, borderWidth: 1, borderColor: "silver", borderRadius: 3, style: { fontWeight: "bold" } },
        dial: { },
        pivot: { },
    ...
    j = {
        type: "gauge",
        pointClass: h.extendClass(h.Point, { setState: function(a) { this.state = a; } }),
        angular: !0,
        translate: function() {
            ...
            p(a.points, function(d) {
                ...
                d.shapeType = "path";
                d.shapeArgs = {
                    d: f.path || ["M", -i, -m / 2, "L", g, -m / 2, e, -h / 2, e, h / 2, g, m / 2, -i, m / 2, "z"],
                    translateX: c[0],
                    translateY: c[1],
                    rotation: (b.startAngleRad +
        ...
        drawPoints: function() {
            ...
            c ? c.animate({ cx: b[0], cy: b[1] }) : a.pivot = a.chart.renderer.circle(b[0], b[1], n(f.radius, 5)).attr({
    ...
    l(r, "translate", function(a) {
        ...
        if (b.isRadial) {
            a = this.points;
            for (g = a.length; g--;)
                b = a[g], b.shapeType = "path", b.shapeArgs = {
                    d: e.symbols.arc(d[0], d[1], c - b.plotY, null, {
                        start: f + b.barX,
                        end: f + b.barX + b.pointWidth,
                        innerR: c -
                            n(b.yBottom, c)
                    })
                }, this.toXY(b);
    ...
    l(w, "getMouseCoordinates", function(a, b) {
        ...
        c.polar ? p(c.axes, function(a) {
            ...
            d[e ? "xAxis" : "yAxis"].push({
                axis: a,
                value: a.translate(e ? Math.PI - Math.atan2(h,
